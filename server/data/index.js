...
export const posts = [
  {
    ...
    comments: [
      { userId: userIds[0], commentText: "random comment" },
  ...
  },
  {
    ...
    comments: [
      { userId: userIds[7], commentText: "one more random comment" },
      { userId: userIds[4], commentText: "and another random comment" },
